...
def get_cpu_stats():
    net_path = 'logs/pascal/2023_0510_pascal_normal'
...
def go_through_visualizations():
    net_path = 'logs/pascal/2023_0510_pascal_normal'
    image_dir_out = 'plots/go_through_visualizations'
    ...
    for i, (idx, batch) in enumerate(zip(idx, dataloader)):
        ...
        plt.show()
        #image_out = os.path.join(image_dir_out, 'im_go_through_visualizations_'+str(idx)+'.pdf')
        #plt.savefig(image_out)
